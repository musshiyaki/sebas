...
这个 custom engine 是 Sebas 存在的原因。CLI 现在只保留为 local chat、engine 和 benchmark workflow 服务的 operational wrapper。
...
| Path | Purpose |
|---|---|
| `sebas` | chat、engine、demo、doctor、benchmark commands 的 main CLI entrypoint |
