...
Sebas は、標準的な常駐型ランタイムには収まりにくい Qwen3.5 MoE モデルを Apple Silicon で動かすためのローカル推論 path に集中しています。Rust CLI は setup、demo、doctor、benchmark のための薄い operational wrapper です。
...
| Path | Purpose |
|---|---|
| `sebas` | engine、demo、doctor、benchmark commands の main CLI entrypoint |
